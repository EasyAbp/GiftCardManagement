...
namespace MyProject.EntityFrameworkCore
{
    ...
    public class MyProjectDbContext : AbpDbContext<MyProjectDbContext>
    {
         ...
         * Also map them inside MyProjectDbContextModelCreatingExtensions.ConfigureMyProject
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            /* Configure your own tables/entities inside the ConfigureMyProject method */
