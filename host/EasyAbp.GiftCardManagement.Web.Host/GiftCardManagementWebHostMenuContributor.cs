...
{
    public class GiftCardManagementWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public GiftCardManagementWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        private void AddLogoutItemToMenu(MenuConfigurationContext context)
        {
            ...
            var l = context.ServiceProvider.GetRequiredService<IStringLocalizer<GiftCardManagementResource>>();
